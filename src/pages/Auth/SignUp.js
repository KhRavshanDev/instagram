    ...
    return (
        <div className="flex items-center justify-center h-screen">
            <div className="flex flex-col">
                <div className="p-10 bg-white border border-gray-primary mb-2 rounded" style={{height: "33rem", width: "23rem"}}>
                    ...
                    <form onSubmit={handleSubmit} className="" method="post">
                        ...
                        <div>
                            <input
                                ...
                                className="text-sm text-gray-base w-full py-5 px-4 h-2 border
                                border-gray-primary rounded mb-7"
                                value={password}
                ...
                <div className="rounded flex justify-center items-center flex-col w-full bg-white p-6 border border-gray-primary">
