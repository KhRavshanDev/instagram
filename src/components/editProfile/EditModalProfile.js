            ...
            >
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        <div className="flex items-start justify-between px-20 py-5 border-b border-solid border-slate-200 rounded-t">
                            <h3 className="text-lg font-semibold">
                                Change profile photo
                            </h3>
                        </div>
                        <div className="flex flex-col">
                            <div className="flex justify-center px-4 py-2 text-blue-400 font-bold border-b">
                                <button
                                    onClick={openInput}
                                >
                                    Upload photo
                            ...
                            <div className="text-red-400 font-bold flex justify-center px-4 py-2 border-b">
                                <button
